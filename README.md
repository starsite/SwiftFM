...
This `README.md` is aimed at Swift devs who want to use the Data API in their UIKit and SwiftUI projects. Each function is paired with a code example. This is **in no way** related to the FIleMaker iOS App SDK (ick).
